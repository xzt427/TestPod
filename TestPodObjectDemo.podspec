#
#  Be sure to run `pod spec lint TestPodObjectDemo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "TestPodObjectDemo"
  s.version      = "0.0.1"
  s.summary      = "A short description of TestPodObjectDemo."
  ...
  s.source       = { :git => "https://github.com/xzt427/TestPod.git", :tag => “0.0.3” }
